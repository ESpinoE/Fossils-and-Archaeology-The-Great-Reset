...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    ANCIENT_HELMET("ancient_helmet", 15, new int[] { 2, 5, 6, 2 }, 0,
            SoundEvents.ARMOR_EQUIP_IRON, 0.0f, 0.0f, () ->{
        return Ingredient.of(ModItems.ANCIENT_HELMET.get());
    });
    ...
    private ModArmorMaterial(String p_i231593_3_, int p_i231593_4_, int[] p_i231593_5_, int p_i231593_6_,
                             SoundEvent p_i231593_7_, float p_i231593_8_, float p_i231593_9_,
                             Supplier<Ingredient> p_i231593_10_) {
    ...
    public String getName() {
        return FaATGRMod.MOD_ID + ":" + this.name;
    }
